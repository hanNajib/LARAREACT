        ...
        <>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <div className="flex flex-col gap-2">
                    <h1 className="font-bold text-2xl md:text-4xl font-poppins text-foreground">
                        { __('welcome :name', { name: user?.name || "User" }) }
                    </h1>
                    <h4 className="text-muted-foreground font-medium text-sm md:text-base">
                        {__('Find the latest information and interesting features on our dashboard')}
                    </h4>
                </div>
                    ...
                    <Card className="relative overflow-hidden group hover:shadow-md transition-all border-l-4 border-l-primary">
                        <CardContent className="p-6 flex items-center justify-between">
                            <div className="space-y-1">
                                <p className="text-sm font-medium text-muted-foreground uppercase tracking-wider">{__('Published articles')}</p>
                        ...
                        <CardHeader className="pb-2">
                            <div className="flex items-center gap-2">
                                <div className="p-2 rounded-md bg-muted">
                                    ...
                                    <CardTitle className="text-sm font-medium">{__('Total articles')}</CardTitle>
                            </div>
                        </CardHeader>
                        <CardContent>
                            ...
                            <div className="mt-4 h-1 w-full bg-zinc-100 rounded-full overflow-hidden">
                                <div className="h-full bg-primary w-[70%]" /> {/* Simulasi target artikel */}
                            </div>
                                <p className="text-[10px] text-muted-foreground mt-2">{__('Target this month: 1,500')}</p>
                        </CardContent>
                    </Card>
                    <Card className="overflow-hidden border-none shadow-sm bg-card">
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground mt-1">
                                <span className="text-emerald-500 font-medium">+12%</span> {__('from last month')}
                            </p>
                        </CardContent>
                    </Card>
                            ...
                            <div className="flex items-center justify-between gap-4">
                                <div className="space-y-1">
                                    ...
                                    <div className="flex items-center gap-1.5 text-xs text-muted-foreground pt-1">
                                        ...
                                        <span><span className="font-medium text-emerald-600">+12%</span> {__('this month')}</span>
                                    </div>
                                </div>
